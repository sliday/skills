...
| Skill | What it does |
|---|---|
| [`hotel-hunting`](./hotel-hunting/SKILL.md) | Fights inflated and fake hotel ratings with Hotelist normalization, adversarial complaint research, photo forensics, provenance checks, duplicate detection, and exact-stay verification. |
...
| [`ux-ui-ia`](./ux-ui-ia/SKILL.md) | Designs and reviews information architecture, flows, controls, accessibility, visual systems, and rendered interfaces using 18 UX laws as evidence-aware diagnostic lenses, an 8px spacing grid, and atomic token-to-component composition. |
